...
This is a webscraping of 'Data Scientist with Python track' in DataCamp Website.
...
url_connection.close() 
page_soup = soup(page_html,"html.parser")
chapter_list_ol = page_soup.find_all('ol',{'chapters chapters--single-column'})
chapter_list = chapter_list_ol[0].find_all('li',{'chapter'})
...
#getting exercise links and exercise names
    ...
    exercise_list_ul = chapter.find_all('ul',{'chapter__exercises'})          
    exercise_list = exercise_list_ul[0].find_all("li", {"chapter__exercise"})
